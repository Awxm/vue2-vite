...
!(function(m) {
  ...
  const d = function(n, t) {
    return (
      ...
      (function(n, t) {
        ...
        return !1;
      })(n.keywords, (n) => f(n.toLowerCase(), t))
    );
  };
    ...
    return (v =
      ...
      function(n) {
        for (var t, e = 1, o = arguments.length; e < o; e++) {
          for (const r in (t = arguments[e])) Object.prototype.hasOwnProperty.call(t, r) && (n[r] = t[r]);
        }
        return n;
      ...
      j.load(n, r).then(
        (n) => {
          ...
          (t = b(n, e)),
            ...
            (i = []),
            C(t, (n, t) => {
              const e = { title: t, keywords: n.keywords, char: n.char, category: P(D, n.category) };
      ...
      return {
        ...
        body: {
          ...
          tabs: (function(n, t) {
            ...
            return o;
          })(u.listCategories(), (n) => ({ title: n, name: n, items: [t, l] })),
        },
        initialData: n,
        onTabChange(n, t) {
  ...
  !(function E() {
    o.add('emoticons', (n, t) => {
      ...
      let a;
      let c;
      const l = ((o = t), (e = n).getParam('emoticons_database_url', `${o}/js/emojis${e.suffix}.js`));
      const s = n.getParam('emoticons_database_id', 'tinymce.plugins.emoticons', 'string');
      const f = L(n, l, s);
      (i = f),
        (u = function() {
          return N(r, i);
